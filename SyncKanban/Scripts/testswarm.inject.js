(function () {
  ...
  window.print = window.confirm = window.alert /* = window.open // <- for funcunit */ = function () { };
  ...
  /// **** custom dell funcunit integration code below
  ...
  // http://docs.jquery.com/QUnit
    ...
    /// **** custom dell funcunit integration code above
